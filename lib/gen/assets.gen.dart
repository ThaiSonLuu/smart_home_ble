...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/ruler.png
  AssetGenImage get ruler => const AssetGenImage('assets/images/ruler.png');

  /// File path: assets/images/smart_home.png
  AssetGenImage get smartHome =>
      const AssetGenImage('assets/images/smart_home.png');
  ...
  List<AssetGenImage> get values =>
      [humidity, more, ruler, smartHome, splash, temperature, time];
}
